...
namespace Test3
{
    public partial class SaltWaterFish : Form
    {
        ...
        private void SaltWaterFish_Load(object sender, EventArgs e)
        {
            LoadFishButtons();
        }
        ...
        private void LoadFishButtons()
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "select distinct p_name from product where p_type = 'SaltWater' and quantity <> 0";
