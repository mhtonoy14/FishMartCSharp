...
namespace Test3
{
    public partial class CultivatedFish : Form
    {
        ...
        public CultivatedFish()
        {
            InitializeComponent();
        }

        private void CultivatedFish_Load(object sender, EventArgs e)
        {
            LoadFishButtons();
        }
        ...
        private void LoadFishButtons()
        {
            ...
            cmd.Connection = conn;
            cmd.CommandText = "select distinct p_name from product where p_type = 'Cultivated'";
